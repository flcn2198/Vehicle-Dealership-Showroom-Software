 ...
 * @author student
 */
public class car10_gallery extends javax.swing.JFrame {

    /**
     * Creates new form car10_gallery
     */
    String id, nam, phn, eml;
    public car10_gallery() {
        initComponents();
        assign10();
    }
    public car10_gallery(String s1, String s2, String s3, String s4, String s5,String s6, String s7, String s8, String s9) {
        initComponents();
        assign10();
        t1.setText(s1);
        t2.setText(s2);
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(436, 438, 110, 30);
        ...
        jButton2.setBounds(589, 438, 100, 30);
    ...
    static String images10[] = {"wrv_fv.png", "wrv_rs.png", "wrv_bv.png", "wrv_ls.png", "wrv_int.png"};
    int c10 = 0;
    ImageIcon[] imglist10 = new ImageIcon[5];
    void assign10(){
        for(int c = 0; c < images10.length; c++){
            imglist10[c] = new ImageIcon(getClass().getResource("/project/c10/"+images10[c]));
        }
    }
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(c10 < 0)
            c10 = 1;
        if(c10 >= 0 && c10 < images10.length)
        { 
            jLabel7.setIcon(imglist10[c10]);
            c10++;
        }
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(c10 >= images10.length)
            c10 = images10.length - 2 ;
        if(c10 >= 0 && c10 < images10.length)
        { 
            jLabel7.setIcon(imglist10[c10]);
            c10--;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        details d = new details("HONDA WR-V", id, nam, phn, eml);
        d.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(car10_gallery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               car10_gallery cr10 = new car10_gallery();
               cr10.setVisible(true);
            }
        });
    }
