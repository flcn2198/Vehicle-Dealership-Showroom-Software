 ...
 * @author student
 */
public class car2_gallery extends javax.swing.JFrame {

    /**
     * Creates new form car2_gallery
     */
    ...
    public car2_gallery(String s1, String s2, String s3, String s4, String s5,String s6, String s7, String s8, String s9) {
        initComponents();
        assign2();
        t1.setText(s1);
        t2.setText(s2);
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/baleno_fv.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/rsz_1download.png"))); // NOI18N
        getContentPane().add(jLabel4);
        jLabel4.setBounds(0, 0, 780, 500);

        pack();
    }// </editor-fold>//GEN-END:initComponents
    static String images2[] = {"baleno_fv.png", "baleno_rs.png", "baleno_bv.png", "baleno_ls.png", "baleno_int.png"};
    int c2 = 0;
    ImageIcon[] imglist2 = new ImageIcon[5];
    void assign2(){
        for(int c = 0; c < images2.length; c++){
            imglist2[c] = new ImageIcon(getClass().getResource("/project/c2/"+images2[c]));
        }
    }
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(c2 < 0)
            c2 = 1;
        if(c2 >= 0 && c2 < images2.length)
        { 
            jLabel7.setIcon(imglist2[c2]);
            c2++;
        }
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(c2 >= images2.length)
            c2 = images2.length - 2 ;
        if(c2 >= 0 && c2 < images2.length)
        { 
            jLabel7.setIcon(imglist2[c2]);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        details d = new details("MARUTI SUZUKI BALENO", id, nam, phn, eml);
        d.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(car2_gallery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                car2_gallery cr2 = new car2_gallery();
                cr2.setVisible(true);
            }
        });
    }
