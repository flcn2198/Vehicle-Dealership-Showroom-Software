 ...
 * @author student
 */
public class car4_gallery extends javax.swing.JFrame {

    /**
     * Creates new form car4_gallery
     */
    ...
    public car4_gallery(String s1, String s2, String s3, String s4, String s5,String s6, String s7, String s8, String s9) {
        initComponents();
        assign4();
        t1.setText(s1);
        t2.setText(s2);
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/city_fv.png"))); // NOI18N
        ...
        jButton1.setBounds(450, 440, 110, 30);
        ...
        jButton2.setBounds(590, 440, 100, 30);
    ...
    static String images4[] = {"city_fv.png", "city_rs.png", "city_bv.png", "city_ls.png", "city_int.png"};
    int c4 = 0;
    ImageIcon[] imglist4 = new ImageIcon[5];
    void assign4(){
        for(int c = 0; c < images4.length; c++){
            imglist4[c] = new ImageIcon(getClass().getResource("/project/c4/"+images4[c]));
        }
    }
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(c4 < 0)
            c4 = 1;
        if(c4 >= 0 && c4 < images4.length)
        { 
            jLabel7.setIcon(imglist4[c4]);
            c4++;
        }
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(c4 >= images4.length)
            c4 = images4.length - 2 ;
        if(c4 >= 0 && c4 < images4.length)
        { 
            jLabel7.setIcon(imglist4[c4]);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        details d = new details("HONDA CITY", id, nam, phn, eml);
        d.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(car4_gallery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new car4_gallery().setVisible(true);
            }
        });
    }
