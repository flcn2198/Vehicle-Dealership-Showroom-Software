 ...
 * @author student
 */
public class car7_gallery extends javax.swing.JFrame {

    /**
     * Creates new form car7_gallery
     */
    ...
    public car7_gallery(String s1, String s2, String s3, String s4, String s5,String s6, String s7, String s8, String s9) {
        initComponents();
        assign7();
        t1.setText(s1);
        t2.setText(s2);
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/octavia_fv.png"))); // NOI18N
        ...
        jButton1.setBounds(446, 447, 110, 30);
        ...
        jButton2.setBounds(589, 447, 110, 30);
    ...
    static String images7[] = {"octavia_fv.png", "octavia_rs.png", "octavia_bv.png", "octavia_ls.png", "octavia_int.png"};
    int c7 = 0;
    ImageIcon[] imglist7 = new ImageIcon[5];
    void assign7(){
        for(int c = 0; c < images7.length; c++){
            imglist7[c] = new ImageIcon(getClass().getResource("/project/c7/"+images7[c]));
        }
    }
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(c7 < 0)
            c7 = 1;
        if(c7 >= 0 && c7 < images7.length)
        { 
            jLabel7.setIcon(imglist7[c7]);
            c7++;
        }
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(c7 >= images7.length)
            c7 = images7.length - 2 ;
        if(c7 >= 0 && c7 < images7.length)
        { 
            jLabel7.setIcon(imglist7[c7]);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        details d = new details("SKODA OCTAVIA", id, nam, phn, eml);
        d.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(car7_gallery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                car7_gallery cr7 = new car7_gallery();
                cr7.setVisible(true);
            }
        });
    }
