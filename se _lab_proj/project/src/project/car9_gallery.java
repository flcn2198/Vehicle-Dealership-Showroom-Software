 ...
 * @author student
 */
public class car9_gallery extends javax.swing.JFrame {

    /**
     * Creates new form car9_gallery
     */
    ...
    public car9_gallery(String s1, String s2, String s3, String s4, String s5,String s6, String s7, String s8, String s9) {
        initComponents();
        assign9();
        t1.setText(s1);
        t2.setText(s2);
    ...
    private void initComponents() {
        ...
        jLabel5.setBounds(10, 174, 86, 30);
        ...
        t1.setBounds(10, 36, 260, 30);

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/verna_fv.png"))); // NOI18N
        ...
        jButton1.setBounds(433, 433, 110, 30);
        ...
        jButton2.setBounds(591, 433, 100, 30);
    ...
    static String images9[] = {"verna_fv.png", "verna_rs.png", "verna_bv.png", "verna_ls.png", "verna_int.png"};
    int c9 = 0;
    ImageIcon[] imglist9 = new ImageIcon[5];
    void assign9(){
        for(int c = 0; c < images9.length; c++){
            imglist9[c] = new ImageIcon(getClass().getResource("/project/c9/"+images9[c]));
        }
    }
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(c9 < 0)
            c9 = 1;
        if(c9 >= 0 && c9 < images9.length)
        { 
            jLabel7.setIcon(imglist9[c9]);
            c9++;
        }
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(c9 >= images9.length)
            c9 = images9.length - 2 ;
        if(c9 >= 0 && c9 < images9.length)
        { 
            jLabel7.setIcon(imglist9[c9]);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        details d = new details("HYUNDAI VERNA", id, nam, phn, eml);
        d.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(car9_gallery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               car9_gallery cr9 = new car9_gallery();
               cr9.setVisible(true);
            }
        });
    }
